...
interface TcHivemindNotionProps {
    ...
    handlePatchHivemindNotion: ({ pageIds, databaseIds }: { pageIds: string[], databaseIds: string[] }) => void;
}
...
function TcHivemindNotion({
    ...
    const [pageIds, setPageIds] = useState<string[]>(defaultNotionHivemindConfig?.pageIds || []);
    const [databaseIds, setDatabaseIds] = useState<string[]>(defaultNotionHivemindConfig?.databaseIds || []);
