  ...
  return (
    <div>
      ...
      >
        ...
        {activeStep === 1 ? (
          <div className="flex flex-col space-y-4 mx-auto text-center justify-center pb-8 px-8">
            <div className="px-14">
            ...
            <TcAlert
              severity="error"
              icon={false}
              className="text-center p-0 flex justify-center bg-error-600/40 rounded-sm"
            >
