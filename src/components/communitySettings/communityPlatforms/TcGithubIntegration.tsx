...
function TcGithubIntegration({ isLoading, connectedPlatforms, handleUpdateCommunityPlatoform }: TcGithubIntegrationProps) {
    ...
    return (
        <div className='flex items-center space-x-3 rounded-sm bg-secondary bg-opacity-5 p-5'>
            ...
            {isLoading ? (
                ...
                connectedPlatforms && connectedPlatforms[0]?.name === 'github' && connectedPlatforms.map((platform, index) => (
                    <Paper
                ...
                <div className='flex flex-col p-5'>
                    ...
                    <div className='p-4 space-y-3'>
                        ...
                        <div className='flex items-center space-x-3'>
                            ...
                            />
                            <div>
                                <TcText text={connectedPlatforms[0]?.metadata?.account?.login} variant='h6' fontWeight='bold' />
