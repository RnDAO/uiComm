...
jest.mock('../../../context/TokenContext', () => ({
    ...
    useToken: jest.fn().mockImplementation(() => ({
        community: { id: '3213215125125521', platforms: [{ id: '312312325152521' }] },
    })),
}));
...
describe('TcRolesAndPermissionsContainer', () => {
    ...
    it('should render DOM elements correctly', () => {
        ...
        expect(screen.getByText('Configure the following for Admins vs. Viewers')).toBeInTheDocument();
    ...
    it('should render the correct text for Admins and Viewers', () => {
        ...
        expect(
            screen.getByText("Viewers can see all the metrics but don't have permission to change the settings.")
        ).toBeInTheDocument();
    });
});
